...
class InstaNerd extends Component {
  ...
  render() {
    return (
      <TabBarIOS tintColor="white" barTintColor="darkslateblue" selectedTab={this.state.selectedTab}>
        <TabBarIOS.Item
...
AppRegistry.registerComponent('InstaNerd', () => InstaNerd);
